...
import org.mule.module.xero.processors.GetJournalsListMessageProcessor;
...
public class GetJournalsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetJournalsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetJournalsListMessageProcessor.class.getName());
