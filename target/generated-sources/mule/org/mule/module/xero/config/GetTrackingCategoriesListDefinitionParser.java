...
import org.mule.module.xero.processors.GetTrackingCategoriesListMessageProcessor;
...
public class GetTrackingCategoriesListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetTrackingCategoriesListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetTrackingCategoriesListMessageProcessor.class.getName());
