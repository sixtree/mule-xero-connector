...
import org.mule.module.xero.processors.GetInvoiceMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetInvoiceDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetInvoiceMessageProcessor.class.getName());
