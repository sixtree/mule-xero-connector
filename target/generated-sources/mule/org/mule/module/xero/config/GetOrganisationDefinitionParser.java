...
import org.mule.module.xero.processors.GetOrganisationMessageProcessor;
...
public class GetOrganisationDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetOrganisationDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetOrganisationMessageProcessor.class.getName());
