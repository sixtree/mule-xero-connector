...
import org.mule.module.xero.processors.GetCreditNotesListMessageProcessor;
...
public class GetCreditNotesListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetCreditNotesListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetCreditNotesListMessageProcessor.class.getName());
