...
import org.mule.module.xero.processors.GetBankTransactionsListMessageProcessor;
...
public class GetBankTransactionsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetBankTransactionsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetBankTransactionsListMessageProcessor.class.getName());
