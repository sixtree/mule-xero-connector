...
import org.mule.module.xero.processors.GetItemsListMessageProcessor;
...
public class GetItemsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetItemsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetItemsListMessageProcessor.class.getName());
