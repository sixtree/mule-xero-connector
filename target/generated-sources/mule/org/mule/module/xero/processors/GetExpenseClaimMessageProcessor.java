...
/**
 * GetExpenseClaimMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getExpenseClaim(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetExpenseClaimMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object expenseClaimId;
    private String _expenseClaimIdType;
    private static Logger logger = LoggerFactory.getLogger(GetExpenseClaimMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setExpenseClaimId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getExpenseClaim"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedExpenseClaimId = ((String) evaluateAndTransform(_muleMessage, GetExpenseClaimMessageProcessor.class.getDeclaredField("_expenseClaimIdType").getGenericType(), null, expenseClaimId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getExpenseClaim"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getExpenseClaim(_transformedExpenseClaimId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getExpenseClaim"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
