...
/**
 * GetBankTransactionMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getBankTransaction(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetBankTransactionMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _bankTransactionIdType;
    private static Logger logger = LoggerFactory.getLogger(GetBankTransactionMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setBankTransactionId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getBankTransaction"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedBankTransactionId = ((String) evaluateAndTransform(_muleMessage, GetBankTransactionMessageProcessor.class.getDeclaredField("_bankTransactionIdType").getGenericType(), null, bankTransactionId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getBankTransaction"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getBankTransaction(_transformedBankTransactionId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getBankTransaction"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
