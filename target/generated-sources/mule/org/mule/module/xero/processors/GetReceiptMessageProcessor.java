...
/**
 * GetReceiptMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getReceipt(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetReceiptMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _receiptIdType;
    private static Logger logger = LoggerFactory.getLogger(GetReceiptMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setReceiptId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getReceipt"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedReceiptId = ((String) evaluateAndTransform(_muleMessage, GetReceiptMessageProcessor.class.getDeclaredField("_receiptIdType").getGenericType(), null, receiptId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getReceipt"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getReceipt(_transformedReceiptId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getReceipt"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
