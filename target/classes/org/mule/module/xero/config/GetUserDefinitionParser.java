...
import org.mule.module.xero.processors.GetUserMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetUserDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUserMessageProcessor.class.getName());
