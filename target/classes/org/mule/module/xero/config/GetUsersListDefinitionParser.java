...
import org.mule.module.xero.processors.GetUsersListMessageProcessor;
...
public class GetUsersListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetUsersListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUsersListMessageProcessor.class.getName());
