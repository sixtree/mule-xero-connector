...
import org.mule.module.xero.processors.GetExpenseClaimsListMessageProcessor;
...
public class GetExpenseClaimsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetExpenseClaimsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetExpenseClaimsListMessageProcessor.class.getName());
