...
import org.mule.module.xero.processors.GetContactsListMessageProcessor;
...
public class GetContactsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetContactsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetContactsListMessageProcessor.class.getName());
