...
import org.mule.module.xero.processors.GetTaxRatesMessageProcessor;
...
public class GetTaxRatesDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetTaxRatesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetTaxRatesMessageProcessor.class.getName());
