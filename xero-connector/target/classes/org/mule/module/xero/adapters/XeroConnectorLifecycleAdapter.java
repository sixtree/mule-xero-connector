...
/**
 * A <code>XeroConnectorLifecycleAdapter</code> is a wrapper around {@link XeroConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class XeroConnectorLifecycleAdapter
    extends XeroConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(XeroConnectorLifecycleAdapter.class);
