...
/**
 * CreateMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#create(org.mule.module.xero.XeroObjectTypes.XeroAllTypes, java.lang.String, java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _optionalPayloadType;
    ...
    /**
     * Sets optionalPayload
     * 
     * @param value Value to set
     */
    public void setOptionalPayload(Object value) {
        this.optionalPayload = value;
    }
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("create"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            ...
            String _transformedOptionalPayload = ((String) evaluateAndTransform(_muleMessage, CreateMessageProcessor.class.getDeclaredField("_optionalPayloadType").getGenericType(), null, optionalPayload));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("create"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.create(_transformedObjectType, _transformedOptionalPayload, _transformedPayload);
