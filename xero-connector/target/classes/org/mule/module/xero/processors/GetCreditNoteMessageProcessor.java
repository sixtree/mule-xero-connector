...
/**
 * GetCreditNoteMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getCreditNote(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetCreditNoteMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object creditNoteId;
    private String _creditNoteIdType;
    private static Logger logger = LoggerFactory.getLogger(GetCreditNoteMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setCreditNoteId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getCreditNote"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedCreditNoteId = ((String) evaluateAndTransform(_muleMessage, GetCreditNoteMessageProcessor.class.getDeclaredField("_creditNoteIdType").getGenericType(), null, creditNoteId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getCreditNote"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getCreditNote(_transformedCreditNoteId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getCreditNote"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
