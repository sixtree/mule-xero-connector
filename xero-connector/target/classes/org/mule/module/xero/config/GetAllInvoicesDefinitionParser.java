...
import org.mule.module.xero.processors.GetAllInvoicesMessageProcessor;
...
public class GetAllInvoicesDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetAllInvoicesDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetAllInvoicesMessageProcessor.class.getName());
