...
import org.mule.module.xero.processors.GetReceiptsListMessageProcessor;
...
public class GetReceiptsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetReceiptsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetReceiptsListMessageProcessor.class.getName());
