...
import org.mule.module.xero.processors.GetPaymentsListMessageProcessor;
...
public class GetPaymentsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetPaymentsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetPaymentsListMessageProcessor.class.getName());
