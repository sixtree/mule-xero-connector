...
import org.mule.module.xero.processors.GetEmployeesListMessageProcessor;
...
public class GetEmployeesListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetEmployeesListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetEmployeesListMessageProcessor.class.getName());
