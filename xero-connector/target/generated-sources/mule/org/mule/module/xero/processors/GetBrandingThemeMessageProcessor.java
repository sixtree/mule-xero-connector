...
/**
 * GetBrandingThemeMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getBrandingTheme(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetBrandingThemeMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object brandingThemeId;
    private String _brandingThemeIdType;
    private static Logger logger = LoggerFactory.getLogger(GetBrandingThemeMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setBrandingThemeId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getBrandingTheme"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedBrandingThemeId = ((String) evaluateAndTransform(_muleMessage, GetBrandingThemeMessageProcessor.class.getDeclaredField("_brandingThemeIdType").getGenericType(), null, brandingThemeId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getBrandingTheme"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getBrandingTheme(_transformedBrandingThemeId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getBrandingTheme"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
