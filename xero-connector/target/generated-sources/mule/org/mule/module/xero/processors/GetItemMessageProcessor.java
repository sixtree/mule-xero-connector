...
/**
 * GetItemMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getItem(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private static Logger logger = LoggerFactory.getLogger(GetItemMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getItem"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedItemId = ((String) evaluateAndTransform(_muleMessage, GetItemMessageProcessor.class.getDeclaredField("_itemIdType").getGenericType(), null, itemId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getItem"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getItem(_transformedItemId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getItem"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
