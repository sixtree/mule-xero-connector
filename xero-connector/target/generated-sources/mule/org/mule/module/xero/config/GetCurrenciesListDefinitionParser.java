...
import org.mule.module.xero.processors.GetCurrenciesListMessageProcessor;
...
public class GetCurrenciesListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetCurrenciesListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetCurrenciesListMessageProcessor.class.getName());
