...
/**
 * GetTrackingCategoryMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getTrackingCategory(java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetTrackingCategoryMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private Object trackingCategoryId;
    private String _trackingCategoryIdType;
    private static Logger logger = LoggerFactory.getLogger(GetTrackingCategoryMessageProcessor.class);
    /**
     * Module object
     * 
     */
     ...
     * @param value Value to set
     */
    public void setTrackingCategoryId(Object value) {
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getTrackingCategory"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedTrackingCategoryId = ((String) evaluateAndTransform(_muleMessage, GetTrackingCategoryMessageProcessor.class.getDeclaredField("_trackingCategoryIdType").getGenericType(), null, trackingCategoryId));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getTrackingCategory"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getTrackingCategory(_transformedTrackingCategoryId);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getTrackingCategory"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
