...
import org.mule.module.xero.processors.GetManualJournalsListMessageProcessor;
...
public class GetManualJournalsListDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public GetManualJournalsListDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetManualJournalsListMessageProcessor.class.getName());
