...
package org.mule.module.xero.processors;
...
import org.mule.module.xero.adapters.XeroConnectorLifecycleAdapter;
...
/**
 * GetTrackingCategoriesListMessageProcessor invokes the {@link org.mule.module.xero.XeroConnector#getTrackingCategoriesList(java.lang.String, java.lang.String)} method in {@link XeroConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class GetTrackingCategoriesListMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private static Logger logger = LoggerFactory.getLogger(GetTrackingCategoriesListMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws InitialisationException
    {
        ...
        if (moduleObject == null) {
            try {
                moduleObject = muleContext.getRegistry().lookupObject(XeroConnectorConnectionManager.class);
                if (moduleObject == null) {
                    throw new InitialisationException(MessageFactory.createStaticMessage("Cannot find object"), this);
                }
            } catch (RegistrationException e) {
                throw new InitialisationException(CoreMessages.initialisationFailure("org.mule.module.xero.adapters.XeroConnectorConnectionManager"), e, this);
            }
        }
        ...
        throws MuleException
    {
        ...
        XeroConnectorConnectionManager _castedModuleObject = null;
        if (moduleObject instanceof String) {
            ...
            if (_castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getTrackingCategoriesList"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            String _transformedWhereClause = ((String) evaluateAndTransform(_muleMessage, GetTrackingCategoriesListMessageProcessor.class.getDeclaredField("_whereClauseType").getGenericType(), null, whereClause));
            String _transformedOrderBy = ((String) evaluateAndTransform(_muleMessage, GetTrackingCategoriesListMessageProcessor.class.getDeclaredField("_orderByType").getGenericType(), null, orderBy));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("getTrackingCategoriesList"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder _messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.getTrackingCategoriesList(_transformedWhereClause, _transformedOrderBy);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getTrackingCategoriesList"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
