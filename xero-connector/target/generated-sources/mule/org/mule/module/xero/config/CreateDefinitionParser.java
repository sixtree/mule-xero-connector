...
import org.mule.module.xero.processors.CreateMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContent) {
        ...
        if (element.hasAttribute("objectType")) {
            builder.addPropertyValue("objectType", element.getAttribute("objectType"));
        }
        if ((element.getAttribute("optionalPayload")!= null)&&(!StringUtils.isBlank(element.getAttribute("optionalPayload")))) {
            builder.addPropertyValue("optionalPayload", element.getAttribute("optionalPayload"));
        }
        if ((element.getAttribute("payload")!= null)&&(!StringUtils.isBlank(element.getAttribute("payload")))) {
            builder.addPropertyValue("payload", element.getAttribute("payload"));
        }
